...
def parse_args(input_args=None):
    ...
    parser.add_argument(
        "--dataset_preprocess_batch_size", type=int, default=100, help="Batch size for preprocessing dataset."
    )
    parser.add_argument(
        "--validation_prompt",
        type=str,
...
def encode_prompt(
    ...
    print("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA", clip_prompt_embeds.shape[-1])
...
def main(args):
    ...
    if text_encoder_three:
        tokenizers.append(tokenizer_three)
        text_encoders.append(text_encoder_three)
    ...
    new_fingerprint = Hasher.hash(time.time())
    ...
    for epoch in range(first_epoch, args.num_train_epochs):
        for step, batch in enumerate(train_dataloader):
            with accelerator.accumulate(controlnet):
                ...
                print("PEPEPEPEPE", prompt_embeds.shape)
